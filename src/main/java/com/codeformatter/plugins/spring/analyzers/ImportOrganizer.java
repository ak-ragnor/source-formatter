...
public class ImportOrganizer implements CodeAnalyzer {
  ...
  public ImportOrganizer(FormatterConfig config) {
    ...
    if (configGroups != null) {
      ...
      this.importGroups =
          Arrays.asList("static", "java", "javax", "org.springframework", "com", "org");
    }
  }
  ...
  private void _checkDuplicateImports(
  ...
  private Map<String, List<ImportDeclaration>> _findDuplicateImports(
  ...
  private Map<String, List<ImportDeclaration>> _groupImportsByPackage(
      List<ImportDeclaration> imports) {
