...
public class FormatterCliTest {
    ...
    public void testVersionCommand() {
        ...
        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("Advanced Code Formatter version"),
    ...
    public void testInitCommand() throws Exception {
        ...
        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("Created configuration file"),
                "Should confirm config file creation");
    ...
    public void testFormatJavaFile() throws Exception {
        ...
        FormatterCli.main(new String[]{"format", filePath, "--config=" + configFile.toAbsolutePath().toString()});

        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("Formatted: ") || output.contains("Successfully formatted"),
                "Should confirm formatting");

        // Verify file was modified
        String formattedContent = Files.readString(javaFile);
        assertFalse(formattedContent.contains("public class   TestClass"),
                "Extra spaces should be removed");
        assertFalse(formattedContent.contains("public void   testMethod(  )"),
                "Extra spaces should be removed");
    }
    ...
    public void testFormatReactFile() throws Exception {
        ...
        assertFalse(formattedContent.contains("function TestComponent( )"),
                "Extra spaces should be removed");
        assertFalse(formattedContent.contains("<div    className=\"container\"   >"),
                "Extra spaces should be removed");
    }
    ...
    public void testFormatDirectory() {
        ...
        FormatterCli.main(new String[]{"format", tempDir.toAbsolutePath().toString(),
                "--config=" + configFile.toAbsolutePath().toString()});

        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("Found") && output.contains("files to format"),
                "Should find files to format");
        assertTrue(output.contains("Formatting complete"),
    ...
    public void testCheckCommand() throws Exception {
        ...
        FormatterCli.main(new String[]{"check", tempDir.toAbsolutePath().toString(),
                "--config=" + configFile.toAbsolutePath().toString()});

        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("File needs formatting:"),
                "Should detect files needing formatting");
        assertTrue(output.contains("Check complete"),
    ...
    public void testAnalyzeCommand() throws Exception {
        ...
        Files.writeString(fileWithIssues,
        ...
        FormatterCli.main(new String[]{"analyze", fileWithIssues.toAbsolutePath().toString(),
                "--config=" + configFile.toAbsolutePath().toString()});

        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("Issues found:"),
                "Should detect issues in the file");
        assertTrue(output.contains("Method") && output.contains("too long"),
    ...
    public void testFileNotFound() {
        ...
        // Verify output
        String output = outContent.toString();
        assertTrue(output.contains("Error: Path does not exist"),
